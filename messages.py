MESSAGES = {
    "ru": {
        "start": (
            ...
            "Немецкий язык, скрытые платежи, куча непонятных документов... Я знаю, как это бесит.\n\n"
            "Я создан, чтобы сделать твой переезд проще. Вот что я умею за 5 секунд:\n\n"
            "Мгновенно перевожу объявления с ImmoScout, Rightmove или Airbnb.\n"
            "Нахожу скрытые платежи (Nebenkosten, Service Charge) и считаю реальную цену.\n"
            "Подсказываю, какие документы требуют хозяева (Schufa, Gehaltsnachweise).\n"
            "Проверяю объявления на мошенников и фейки.\n\n"
            "Как начать?\n"
